    ...
    return {
      ...
      meta: [
        ...
        { property: 'og:description',
          content: '把愛傳出去，台積電基金會2014年起，走訪遍布全台的醫療、社福單位，尋找一樣對獨居老人，有協助意願的夥伴，串接起志同道合的點與線，打造全國性的獨居老人照顧網─「愛互聯」。目前在全台，「兵分六區」投入服務行動（北部、竹苗、台中、台南、高雄、花東），今年還有14家偏遠地區醫院，和更多的社福單位，表示有意願加入串連。針對獨老醫療，位於各縣市的愛互聯醫療單位，首先為低收入的獨居老人....。台積電慈善基金會-把愛傳出去。'
        },
        { hid: 'description',
          name: 'description',
          content: '把愛傳出去，台積電基金會2014年起，走訪遍布全台的醫療、社福單位，尋找一樣對獨居老人，有協助意願的夥伴，串接起志同道合的點與線，打造全國性的獨居老人照顧網─「愛互聯」。目前在全台，「兵分六區」投入服務行動（北部、竹苗、台中、台南、高雄、花東），今年還有14家偏遠地區醫院，和更多的社福單位，表示有意願加入串連。針對獨老醫療，位於各縣市的愛互聯醫療單位，首先為低收入的獨居老人....。台積電慈善基金會-把愛傳出去。'
        ...
        { name: 'keywords',
          content: '愛、老人、關懷、醫療、弱勢、社福、捐款、台積電、tsmc、互聯、慈善、基金會、CSR、倡議、志工、UDN、聯合報、張淑芬'
        },
      ]
    }
  },   
